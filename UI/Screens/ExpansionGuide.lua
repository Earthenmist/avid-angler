...
local function IsAppearanceCollected(itemID)
    ...
    if type(C_TransmogCollection.GetItemInfo) == "function" and type(C_TransmogCollection.GetAppearanceSources) == "function" then
        local appearanceID = AvidAngler:SafeCall(C_TransmogCollection.GetItemInfo, nil, itemID)
        if appearanceID then
            local sources = AvidAngler:SafeCall(C_TransmogCollection.GetAppearanceSources, nil, appearanceID)
